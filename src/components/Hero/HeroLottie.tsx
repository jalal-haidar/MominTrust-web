...
const CDN_FALLBACK = 'https://assets10.lottiefiles.com/packages/lf20_tfb3estd.json';
...
const HeroLottie = ({ path, animationData, style }: Props) => {
  ...
  useEffect(() => {
    ...
    const loadFromData = (data: unknown) => {
      ...
      animRef.current = lottie.loadAnimation({ ...baseOptions, animationData: data });
    };
  ...
  return <div ref={ref} style={style as React.CSSProperties | undefined} aria-hidden="true" />;
};
