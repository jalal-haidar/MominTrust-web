...
const SupportSection: React.FC<SupportSectionProps> = ({
  ...
  donationCardProps = {
    ...
    impactItems: [
      ...
      { icon: LocalLibraryIcon, amount: 100, description: 'Full scholarship for one month' },
    ],
      ...
      <Grid container spacing={4} alignItems="center">
        ...
        <Grid item xs={12} md={6}>
          ...
          <Typography variant="body2" sx={{ mb: 2 }}>
            <strong>{fundPercentage} of funds</strong> go directly to student support through:
          </Typography>
          <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1, mb: 3 }}>
            <Chip icon={<SchoolIcon />} label="Tuition" color="primary" variant="outlined" />
            <Chip icon={<MenuBookIcon />} label="Textbooks" color="primary" variant="outlined" />
            <Chip
